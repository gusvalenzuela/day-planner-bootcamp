!(function (e) {
	...
	145: function (e, t, n) {
		...
		;(0, o.default)("#mainContentContainer").data("received-session") &&
			((0, o.default)("#nav-signup-link").hide(),
			(0, o.default)("#nav-login-link").hide(),
			(0, o.default)("#nav-logout-link").show(),
			(0, o.default)("#nav-dashboard-link").show())
	},
	2: function (e, t, n) {
		var r
		/*!
			...
			C.ajaxSetup({
				...
				C.each(["top", "left"], function (e, t) {
					C.cssHooks[t] = Xe(v.pixelPosition, function (e, n) {
						if (n)
							return (n = Ue(e, t)), Be.test(n) ? C(e).position()[t] + "px" : n
					})
				}),
